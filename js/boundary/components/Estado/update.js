const template = document.createElement('template');
	...
	function showUserUpdateBox(id) {
		...
		xhttp.open("GET", "https://267f-168-243-180-166.ngrok.io/BachesRest/resources/estado/findById/"+id);
		xhttp.send();
	...
	function userUpdate() {
		...
		const xhttp = new XMLHttpRequest();
		xhttp.open("PUT", "https://267f-168-243-180-166.ngrok.io/BachesRest/resources/estado/crear?id="+id+"&nombre="+nombre+"&observacion="+observaciones);
